...
export default function AppShell({ children }: { children: React.ReactNode }) {
  ...
  if (isLoginPage) {
    return (
      <div className="min-h-screen w-full flex flex-col bg-[#070D1C] text-archaia-text font-sans">
  ...
  return (
    <div className="min-h-screen flex flex-col bg-archaia-darker text-archaia-text font-sans">
      <Navbar />
