export default function Loading() {
  return (
    <div className="space-y-6 w-full animate-in fade-in duration-200" aria-busy="true" aria-live="polite">
      ...
      <div className="h-16 w-full rounded-2xl bg-white/80 border border-slate-200 animate-pulse flex items-center px-6 justify-between">
      ...
      <div className="card-shades relative overflow-hidden rounded-3xl p-6 sm:p-8 border border-slate-200 space-y-4 animate-pulse">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {[1, 2, 3, 4].map((i) => (
          <div
            key={i}
            className="p-5 rounded-2xl bg-white/70 border border-slate-200 space-y-3 animate-pulse"
          >
